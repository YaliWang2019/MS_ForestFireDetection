...
full_dataset = ImageFolder('C:/Users/nicol/Downloads/GreenHot', transform=transform)
...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=10, kernel_size=6)
        ...
        # Third convolutional layer
        self.conv3 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=4)
        self.pool3 = nn.MaxPool2d(kernel_size=(2, 2))
        
        # Fourth convolutional layer
        self.conv4 = nn.Conv2d(in_channels=10, out_channels=5, kernel_size=4)
        self.pool4 = nn.MaxPool2d(kernel_size=(2, 2))
        
        # Fifth convolutional layer
        self.conv5 = nn.Conv2d(in_channels=5, out_channels=2, kernel_size=3)
...
optimizer = optim.Adam(model.parameters(), lr=0.0001)  # Changed optimizer to Adam
...
torch.save(model.state_dict(), 'gh_pytorch_cnn_add2.pth')
