...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(in_channels=10, out_channels=5, kernel_size=4)
        self.pool3 = nn.MaxPool2d(kernel_size=(2, 2))
        
        # Third convolutional layer
        self.conv4 = nn.Conv2d(in_channels=5, out_channels=2, kernel_size=3)
        self.pool4 = nn.MaxPool2d(kernel_size=(2, 2))

        self.fc1 = nn.Linear(338, 100)
...
torch.save(model.state_dict(), 'gh_pytorch_cnn_add1.pth')
