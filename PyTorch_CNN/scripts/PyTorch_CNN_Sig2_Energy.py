...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(self.fc_output_shape, 50)  # Adjusted to 25 to match the input of fc3
...
model.load_state_dict(torch.load('pytorch_cnn_sig2.pth', map_location=device))
model.to(device)
...
def foo():
    # Open the csv file
    with open('pytorch_cnn_Sig2_420_pred1.csv', 'w', newline='') as file:
